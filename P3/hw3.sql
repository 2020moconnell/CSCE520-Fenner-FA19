create table Product( 
     ...
     CONSTRAINT checkType check (type='pc' or type='laptop' or type='printer' or type='smartphone' or type='tablet'));
...
create table PC(
     ...
     hd int,
     price decimal(10,2),
     foreign key (model) references product(model) on delete no action);
